...
sprites.onOverlap(SpriteKind.Player, SpriteKind.UncollectedBerry, function (playerSprite, berrySprite) {
    if (heldBerry == null) {
        info.startCountdown(crossingTime)
        ...
        berrySprite.setImage(img`
            ...
            . . . . . . . . . . . . . . . . 
            `)
        berrySprite.setKind(SpriteKind.CollectedBerry)
        berriesLeft -= 1 
...
Fish = sprites.create(img`
    ...
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.Player)
tiles.placeOnTile(Fish, tiles.getTileLocation(5, 17))
